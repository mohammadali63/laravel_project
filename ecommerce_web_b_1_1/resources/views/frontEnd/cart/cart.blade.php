                                    ...
                                    @foreach($cart_products as $cart_product)
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" onclick="return confirm('are you sure delete this')" class="remove" href="{{route('cart.remove',['id'=>$cart_product->id])}}">×</a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    <form action="{{route('cart.update',['id'=>$cart_product->id])}}" method="POST">
                                                        @csrf
                                                        <input type="number" size="4" class="input-text qty text" name="quantity" value="{{$cart_product->quantity}}" min="0" step="1">
