            ...
            <div class="col-lg-8">
                <div class="card shadow-lg border-0 rounded-lg my-3">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-2">Edit Color</h3>
                    ...
                    <div class="card-body">
                        <form action="{{route('update.color')}}" method="post" >
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class=" mb-3">
                                        <input class="form-control" name="color_name" type="text" value="{{$color->color_name}}"  />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="">
                                        <input class="form-control" name="color_code" type="text" value="{{$color->color_code}}"  />                                    </div>
                                </div>
                            </div>
